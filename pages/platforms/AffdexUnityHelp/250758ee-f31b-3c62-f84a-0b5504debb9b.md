...
\[Missing <summary> documentation for "T:Affdex.Measurements"\]
...
**VB**<br />
``` VB
Public Structure Measurements
```

**C++**<br />
``` C++
public value class Measurements
```

**F#**<br />
``` F#
[<SealedAttribute>]
type Measurements =  struct end
```

The Measurements type exposes the following members.
...
<a href="#measurements-structure">Back to Top</a>
