...
+   Introducing the SDK.pdf <br>
+   SDK Developer Guide.pdf (this document) <br>
+   docs, the folder containing documentation. In the javadoc subfolder, start with index.html. <br>
+   libs, the folder containing Affdex SDK libraries that your app will link against assets, the folder containing files needed by the SDK <br>
...
+   Adding the SDK to your Android project <br>
+   Using the SDK <br>
+   Options <br>
+   Interpreting the data <br>
+   A note about SDK analytics (Flurry) <br>
